	...
	<div class="big-wrapper">
		<div class="wrapper-block">
			<form action="https://api.web3forms.com/submit" method="POST">
				<input type="hidden" name="access_key" value="462cfcd8-e464-47cd-8317-89825ed7a6f2" />
				...
				<textarea id="Bericht" name="Bericht" placeholder="BERICHT" rows="4" required />

				<input type="hidden" name="redirect" value="https://web3forms.com/success" />

				<!-- <input class="file-upload" type="file" id="myFile" name="filename" > -->
		...
		<img
			src="https://images.unsplash.com/photo-1605449670493-ca1d812d0488?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1936&q=80"
			alt=""
		/>
	</div>
</section>
...
<style>
	...
	input {
		height: 6rem;
		border: 0px;
		border-bottom: 3px solid var(--color-primair);
	...
	@media screen and (max-width: 700px) {
      ...
      padding-left: 1em;
		...
		input {
			height: 2rem;
			border-bottom: 2px solid var(--color-primair);
			font-size: 1.5rem;
		}
